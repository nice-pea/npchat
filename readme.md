  ...
  * Список сообщений:
    ...
    * По нажатию открывается меню
      * Компоненты:
        ...
        * Кнопка удалить сообщение (необязательно)
        * Кнопка изменить сообщение (необязательно)

### Экран/диалог поиска сообщений -

### Диалог профиля чата со списком участников -
...
* Внутри чата должна быть возможность осуществлять поиск по истории сообщений и списку участников
