...
* Компоненты:
  ...
  * Инпут логина
  * Кнопка "вход"
* После ввода логина и нажатия далее, производится проверка совместимости версии апи
* после удачной проверки апи, открывается **экран чатов**
