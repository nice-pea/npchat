...
func (_m *MembersRepositoryMock) Delete(id uint) error {
	ret := _m.Called(id)
...
func (_c *MembersRepositoryMock_Delete_Call) Run(run func(id uint)) *MembersRepositoryMock_Delete_Call {
...
func (_c *MembersRepositoryMock_Delete_Call) RunAndReturn(run func(uint) error) *MembersRepositoryMock_Delete_Call {
	_c.Call.Return(run)
	return _c
}
